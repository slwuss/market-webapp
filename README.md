...
```bash
https://github.com/slwuss/market-webapp.git
```

chnage directory to terraform:

```bash
cd market-webapp/terraform/
```
...
Access the website `app.your-domain.com`
...
NAME               HOSTNAMES                   AGE
grafana-route      ["grafana.your-domain.com"]      30m
prometheus-route   ["prometheus.your-domain.com"]   41s
```
...
NAME           HOSTNAMES               AGE
kibana-route   ["kibana.your-domain.com"]   74s
```
